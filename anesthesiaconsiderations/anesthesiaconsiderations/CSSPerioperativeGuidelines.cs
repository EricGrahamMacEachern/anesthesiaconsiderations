...
{
    class CSSPerioperativeGuidelines : ContentPage
    {
        public CSSPerioperativeGuidelines()
        {
            ...
            {
                Text = "2017 CSS Perioperative Guidelines",
                    ...
                    Children =
                    {
                         ...
                         new StackLayout
                        {
                            ...
                            Children =
                            {
                                ...
                                {
                                    FontSize = 16,
                                    Text = "Summary flow diagram: see figure 1 in page 3 of the guideline ",
                                    TextColor = Color.Black,
                         ...
                         new StackLayout
                        {
                            ...
                            Children =
                            {
                                ...
                                {
                                    FontSize = 16,
                                    Text = "Adapted from Canadian Cardiovascular Society Guidelines on Perioperative Cardiac Risk Assessment and Management for Patients Who Undergo Noncardiac Surgery. Canadian Journal of Cardiology. January 2017, Volume 33, Issue 1, Pages 17–32 See full guideline here: ",
                                    TextColor = Color.Black,
                                    HorizontalOptions = LayoutOptions.Start
                                },
                            }
